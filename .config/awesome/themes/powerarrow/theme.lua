...
local themes                                     = {}
themes.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-dark"
...
-- Textclock
--local clockicon = wibox.widget.imagebox(themes.widget_clock)
local clock = awful.widget.watch(
    "date +'%a %d %b %R'", 60,
    function(widget, stdout)
        widget:set_markup(" " .. markup.font(themes.font, stdout))
    end
)
-- Calendar
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget {clock,layout = wibox.layout.align.horizontal}, "#777E76"),
            --]]
            -- using separators
            ...
            arrow(theme.bg_normal, "#343434"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#343434"),
            arrow("#343434", "#777E76"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#777E76"),
            arrow("#777E76", "#4B696D"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#4B696D"),
            arrow("#4B696D", "#4B3B51"),
            ...
            arrow("#4B3B51", "#CB755B"),
            wibox.container.background(wibox.container.margin(wibox.widget {clock,layout = wibox.layout.align.horizontal}, dpi(4), dpi(8)), "#CB755B"),
            arrow("#CB755B", "#alpha"),
            --]]
            s.mylayoutbox,
        },
