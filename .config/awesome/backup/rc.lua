...
-- ### above these line were uncommented
...
globalkeys = gears.table.join(
    ...
    --Screenshot
        awful.key({ }, "Print", function () awful.spawn.with_shell("gnome-screenshot") end,
            {description = "takes a full screen capture as is", group = "Screenshot"}),
        awful.key({ "Shift" }, "Print", function () awful.spawn.with_shell("gnome-screenshot -a") end,
            {description = "specific region that we can select at will", group = "Screenshot"}),
        awful.key({ "Alt" }, "Print", function () awful.spawn.with_shell("gnome-screenshot -w") end,
            {description = "current window screenshot", group = "Screenshot"}),
        awful.key({ "Control", "Alt" }, "Print", function () awful.spawn.with_shell("gnome-screenshot -w -c") end,
            {description = " current window to the clipboard", group = "Screenshot"}),
        awful.key({ "Control" }, "Print", function () awful.spawn.with_shell("gnome-screenshot -c") end,
            {description = "entire screen capture to Clipboard", group = "Screenshot"}),
        awful.key({ "Control", "Shift"}, "Print", function () awful.spawn.with_shell("gnome-screenshot -a -c") end,
            {description = "screenshot of a specific region to clipboard", group = "Screenshot"}), 
    -- file explorer
...
-- Functions
    ...
    awful.spawn.with_shell("feh --bg-fill --random /home/niks/Pictures/Wallpaper")
    awful.spawn.with_shell("compton")
    
    ---)
    ---### below there are two function which can enable the title bars for the floating windows.
